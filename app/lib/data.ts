...
// // ✅ NOTE: Replaced old connection line with robust version
// let rawConn =
...
// if (!rawConn) {
//   throw new Error(
//     '❌ Missing DB connection string. Set POSTGRES_URL or DATABASE_URL in your .env file.'
//   );
// }

// let connectionString = rawConn.startsWith('postgresql://')
//   ? rawConn.replace('postgresql://', 'postgres://')
//   : rawConn;

// try {
//   const hostPart = connectionString.split('@')[1]?.split('/')[0] ?? 'unknown';
//   console.log('✅ DB host (debug):', hostPart);
// } catch {
//   console.log('⚠️  Could not extract DB host.');
// }
...
//     // ✅ NOTE: temporary safe fallback (instead of crashing)
//     return [];
//   }
// }
